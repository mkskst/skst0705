    ...
    <div id="cart" class="container-fluid">
        <div id="cart_box" class="row">
            <div id="cart_box__body" class="col-md-10 col-md-offset-1">
                ...
                <form name="form" id="form_cart" method="post" action="{{ url('cart') }}" class="clearfix">
                        ...
                        <div id="cart_item_list__body" class="tbody">
                            ...
                            {% for CartItem in Cart.CartItems %}
                                ...
                                <div id="cart_item_list__item" class="item_box tr">
                                    <div class="clearfix"><div id="cart_item_list__cart_remove" class="icon_edit td">
                                    ...
                                    <div class="td table">
                                        ...
                                        <dl class="item_detail">
                                            ...
                                            <dd id="cart_item_list__item_price" class="item_price">＠{{ CartItem.price|number_format }} ×  {{ CartItem.quantity|number_format }}</dd>
                                        </dl>
                                    </div>
									...
									<div id="cart_item_list__item_subtotal" class="item_subtotal">小計　{{ CartItem.total_price|number_format }}円</div>
                                </div><!--/item_box-->
                            {% endfor %}
                    ...
                    <div class="total_box">
                        <dl id="total_box__total_price" class="total_price">
                            <dt>合計　</dt>
                            <dd class="text-primary">{{ Cart.total_price|number_format }}円</dd>
                        </dl>
                        <div id="total_box__user_action_menu" class="btn_group">
                            ...
                            <p id="total_box__top_button" class="txt_center">
                                <a  href="{{ url('top') }}" class="btn btn-default btn-block">お買い物を続ける</a>
                            </p>
                        </div>
                    </div>
